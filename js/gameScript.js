...
function updateGameArea() {
    ...
    if (myGameArea.frameNo == 1 || everyinterval(150)) {
        ...
        myObstacles.push(new component(10, height, "#1a9fff", x, 0));
        myObstacles.push(new component(10, x - height - gap, "#1a9fff", x, height + gap));
        generateBonus();
    }
...
function generateBonus() {
    ...
    myBonuses.push(new component(10, 10, "white", bonusX, bonusY));
}
